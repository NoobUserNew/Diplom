		...
		<div className={styles.homeContainer}>
			...
			<section className={styles.heroSection}>
				...
				<div className={styles.heroContent}>
					...
					<p>
						основная цель – хозяйственная деятельность, направленная на получение прибыли.
					</p>
			...
			<div className={styles.mainContent}>
				...
				<section className={styles.aboutSection}>
					...
					<p className={styles.sectionDescription}>
						Основными видами деятельности являются участников Холдинга является производство муки, крупы, комбикормов. Пресноводной рыбы и свиноводство.
					</p>
