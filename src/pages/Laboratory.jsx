		...
		<div className={styles.laboratory}>
			<div className={styles.container}>
				...
				<p className={styles.content}>
					...
					показателям безопасности и радиометрическому контролю, в соответствии
					с утвержденной областью аккредитации. Испытания проводятся на
					соответствие ТНПА, действующих на территории Республики Беларусь
					(ГОСТ, СТБ, ГОСТ Р), а также технических регламентов Республики
					Беларусь и Таможенного союза.
					<br />
					...
					<ul>
						...
						<li>Аттестат аккредитации № BY/112 02.1.0.1037 от 25.08.1997 г;</li>
						<li>
					...
					<br />
					Заключить договор на испытания, получить консультацию можно по адресу
					г. Брест, ул. Карбышева, 119, производственная лаборатория (1 этаж)
					или по телефонам 20-46-61, 20-05-92.
				</p>
